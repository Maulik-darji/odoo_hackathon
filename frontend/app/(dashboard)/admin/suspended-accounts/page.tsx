...
export default function SuspendedAccountsPage() {
  ...
  const filteredUsers = users.filter((u) => {
    ...
    // Suspended accounts are those who are not approved and not admin
  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto">
        ...
        <div className="space-y-1">
          <div className="flex items-center gap-3">
            <h1 className="text-4xl font-normal tracking-tight">
              Suspended <span className="serif-italic">Accounts</span>
            </h1>
          ...
          <p className="text-slate-500 text-sm">
            View and manage users whose access has been suspended.
          </p>
        </div>
      ...
      {/* Filters Bar */}
      <div className="flex justify-between gap-4 items-center bg-white/40 backdrop-blur-md p-3 border border-white/60 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.02)]">
        {/* Search */}
            ...
            {filteredUsers.length === 0 ? (
              ...
              filteredUsers.map((item) => (
                <tr key={item.id} className="hover:bg-white/40 transition-colors">
                  ...
                  {/* Status */}
                  <td className="p-4">
                      <Badge className="bg-red-50 text-red-700 border-red-200/60 font-semibold text-[10px]">
                        Suspended
                      </Badge>
                  </td>
